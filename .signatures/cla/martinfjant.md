...
attestation: "I, @martinfjant, agree to the following Sigil Contributor License Agreement, version 1.0."
client: sigil@0.1.0
---
...
1. **Ownership.** You confirm the contribution is your original work, or that
...
3. **Patent grant.** You grant a perpetual, worldwide, non-exclusive,
   ...
   that are necessarily infringed by your contribution, for use, modification,
   and distribution of Sigil.

4. **Transfer.** You grant Max Malm the right to transfer or assign the rights
   in this agreement to a successor entity established to steward Sigil,
   provided that entity is bound by the same requirement: Sigil remains licensed
   under AGPL-3.0 or a later version of the GNU AGPL.

5. **You keep your copyright.** You retain all rights to your contribution and
